...
extension OrderModelQueryFilter
  ...
  QueryBuilder<OrderModel, OrderModel, QAfterFilterCondition> dateTimeEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<OrderModel, OrderModel, QAfterFilterCondition> dateTimeLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<OrderModel, OrderModel, QAfterFilterCondition> dateTimeBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension OrderModelQuerySortBy
  ...
  QueryBuilder<OrderModel, OrderModel, QAfterSortBy> sortByDateTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dateTime', Sort.asc);
    });
  }

  QueryBuilder<OrderModel, OrderModel, QAfterSortBy> sortByDateTimeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension OrderModelQuerySortThenBy
  ...
  QueryBuilder<OrderModel, OrderModel, QAfterSortBy> thenByDateTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dateTime', Sort.asc);
    });
  }

  QueryBuilder<OrderModel, OrderModel, QAfterSortBy> thenByDateTimeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dateTime', Sort.desc);
    });
  }
...
extension OrderModelQueryWhereDistinct
  ...
  QueryBuilder<OrderModel, OrderModel, QDistinct> distinctByDateTime() {
    return QueryBuilder.apply(this, (query) {
...
extension OrderModelQueryProperty
  ...
  QueryBuilder<OrderModel, DateTime, QQueryOperations> dateTimeProperty() {
    return QueryBuilder.apply(this, (query) {
...
int _orderItemModelEstimateSize(
  ...
  var bytesCount = offsets.last;
  bytesCount += 3 + object.productBarcode.length * 3;
...
void _orderItemModelSerialize(
  ...
  writer.writeString(offsets[1], object.productBarcode);
...
OrderItemModel _orderItemModelDeserialize(
  ...
  object.productBarcode = reader.readString(offsets[1]);
